...
**Total Instances:** 54 (38 active, 16 unused/reserved)  
**Highest Instance ID:** 54
...
| 6 | DHCP Enabled | BOOL | - | Yes | - | - | - | Enable DHCP for automatic IP configuration (1=enabled, 0=static) |
...
| 20 | ACD Enabled | BOOL | - | Yes | - | - | - | Enable Address Conflict Detection (1=enabled, 0=disabled) |
...
| Instance ID | Parameter Name | Data Type | Units | Settable | Min | Max | Default | Description |
|------------|----------------|-----------|-------|----------|-----|-----|---------|-------------|
| 10 | NAU7802 Enabled | BOOL | - | Yes | - | - | - | Enable/disable NAU7802 weight scale sensor |
...
| Instance ID | Parameter Name | Data Type | Units | Settable | Min | Max | Default | Description |
|------------|----------------|-----------|-------|----------|-----|-----|---------|-------------|
| 22 | VL53L1X Enabled | BOOL | - | Yes | - | - | - | Enable/disable VL53L1X time-of-flight sensor |
...
## Reserved Instances (38-49)

| Instance ID | Status |
|------------|--------|
| 38-49 | Reserved for future use (e.g., LSM6DS3, MCP230XX parameters) |
...
1. **Instance Allocation:** The Parameter Object allocates 54 instances to support non-sequential instance IDs. Unused instances (7-9, 20-21, 38-49, 52) are reserved for future expansion.
...
- **Instances 7-9:** Additional network configuration
