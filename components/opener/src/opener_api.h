...
#if defined(STM32) || defined(ESP32)	/** STM32 or ESP32 target -> uses a struct for the network interface */
...
#if defined(STM32) || defined(ESP32)  /** STM32 or ESP32 target, the hostname is linked to the network interface */
/** @ingroup CIP_API
